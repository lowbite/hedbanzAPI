...
public enum UserError {
    ...
    INCORRECT_PASSWORD(2, ErrorMessages.INCORRECT_PASSWORD),
    ...
    INVALID_PASSWORD(8, ErrorMessages.INCORRECT_PASSWORD),
    INVALID_LOGIN(9, ErrorMessages.INCORRECT_LOGIN),
    INVALID_EMAIL(10, ErrorMessages.INCORRECT_EMAIL),
    ...
    INCORRECT_CREDENTIALS(16, ErrorMessages.INCORRECT_CREDENTIALS);
