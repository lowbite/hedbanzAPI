...
public enum RoomError {
    ...
    WRONG_PASSWORD(2, ErrorMessages.INCORRECT_PASSWORD),
    ...
    PLAYER_HAS_ACTIVE_ROOMS_MAX_NUMBER(15, ErrorMessages.MAX_ACTIVE_ROOMS_NUMBER),
    NO_SUCH_MESSAGE(16, ErrorMessages.NO_SUCH_MESSAGE),
    SUCH_ROOM_ALREADY_EXIST(17, ErrorMessages.SUCH_ROOM_ALREADY_EXIST),
    EMPTY_SITCKER_ID(18, ErrorMessages.EMPTY_STICKER_ID),
    EMPTY_ICON_ID(19, ErrorMessages.EMPTY_ICON_ID);
