...
public class SocketMessagingController {
    ...
    public SocketMessagingController(PlayerService playerService, @Qualifier("APIConversionService")ConversionService conversionService, UserService userService) {
